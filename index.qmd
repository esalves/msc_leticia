...
Esta seção resume os cruzamentos estatísticos realizados pela estatística entre as características maternas/neonatais e a faixa etária materna em 4 categorias: **11-15 anos** (adolescentes precoces), **16-19 anos** (adolescentes tardias), **20-34 anos** (adultas) e **35 anos ou mais**. Para todos os cruzamentos, utilizou-se o teste do **Qui-quadrado de Pearson** para avaliar a significância da associação.
...
* **Comorbidades Crônicas:** Frequência significativamente superior nas adultas e gestantes de 35+ anos:
  * `patologia_materna` (geral): 3,4% (11-15 anos) vs. 28,7% (20-34 anos) vs. 40,0% (35+ anos) ($p < 0,001$).
  * Hipertensão Crônica (`hac_pre`): 0,4% nas adolescentes vs. 7,4% nas adultas e 15,6% nas de 35+ ($p < 0,001$).
...
* **Patologias Gestacionais:**
  * Diabetes Gestacional (`dmg` e `dmg_obst`): Muito mais frequente em adultas de 20-34 anos (10,6%) e 35+ (22,7%) do que em adolescentes (0,5%) ($p < 0,001$).
  ...
  * Ruptura de Membranas (`rpmo`): Mais frequente nas adultas (8,6%) e de 35+ (7,3%) vs. adolescentes (0,0-0,2%) ($p < 0,001$).
...
### Desfechos Neonatais
* **Prematuridade e Baixo Peso:** Nascimento pré-termo (< 37 semanas) e peso inferior a 2500g são mais frequentes nas adultas (prematuridade: 24,4% vs. 10,4% nas adolescentes precoces) ($p < 0,001$).
* **Apgar:** Taxas de Apgar baixo (< 7) no 1º e 5º minutos são ligeiramente maiores nas adultas ($p < 0,05$).
* **Malformação Fetal:** Mais comum em adultas (6,9%) e 35+ (4,8%) do que nas adolescentes (~1,8%) ($p < 0,001$).
